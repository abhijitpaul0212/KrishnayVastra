...
//         // Handle Modal for Homepage Images
//         if (images.length > 0) {
...
//              // Function to handle modal for mainImage (Product-specific page)
//             if (mainImage) {
...
document.addEventListener('DOMContentLoaded', () => {
    // Selectors for modal functionality
    const images = document.querySelectorAll('.slider-image'); // For homepage images
    const modal = document.getElementById('image-modal');
    const modalImage = document.getElementById('popup-image');
    const mainImage = document.getElementById('main-image'); // For product pages
    const modalImageName = document.getElementById('modal-image-name');
    const modalAddToCartButton = document.getElementById('modal-add-to-cart');
    const closeModal = document.querySelector('.close');
    const prevButton = document.querySelector('.prev');
    ...
    // Ensure the modal and required elements exist
    if (modalImage && closeModal) {
        ...
        if (images.length > 0) {
            ...
            // Add Navigation Logic for Modal
        ...
        console.warn("Modal image or related elements not found.");
    }
});
